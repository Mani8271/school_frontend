...
import { Upload, Add, Download, Edit, Delete, Close } from "@mui/icons-material";
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-4 py-3 bg-gray-50 border-t w-full text-sm">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className={`px-4 py-2 border ${
              page >= Math.ceil(filteredStudents.length / rowsPerPage) - 1 ? "text-gray-400 cursor-not-allowed" : "text-gray-900 hover:bg-gray-100"
            }`}
          >
            Next
          </button>
