...
// import { useBranch } from "./Branches"; // Import branch selection
...
//     if (!eventDetails.name || !eventDetails.fromDate || !eventDetails.toDate) {
//       alert("All fields are required!");
//       return;
//     }

//     const eventKey = selectedDate || eventDetails.fromDate;
...
//     setShowModal(false);
//     setEventDetails({ name: "", fromDate: "", toDate: "", description: "" });
...
//   return (
//     <div className="p-4 space-y-6 overflow-hidden " style={{ height: "90vh" }}>
//       <div className="flex items-center justify-between">
//         <h1 className="text-3xl font-semibold">Holiday Declarations</h1>
//         <Button
//           color="primary"
//           title="add event"
...
//             // ✅ Ensure the event matches the selected branch before displaying
//             if (event && event.branch && event.branch.trim().toLowerCase() === selectedBranch.trim().toLowerCase()) {
//               return (
//                 <div key={day} onClick={() => handleEventClick(eventKey)} className="relative h-24 p-2 border border-gray-300 rounded-lg cursor-pointer md:h-32 hover:shadow-md">
//                   <span className="absolute text-sm font-bold text-gray-800 top-1 right-2">{day}</span>
...
//             } else {
//               return (
//                 <div key={day} className="relative h-24 p-2 border border-gray-300 rounded-lg md:h-32">
//                   <span className="absolute text-sm font-bold text-gray-800 top-1 right-2">{day}</span>
//                 </div>
//               );
//             }
...
//               {selectedDate ? "Edit Event" : "Add Event"}
//             </h2>
//             <form>
//               <div className="mb-4">
//                 <TextField
